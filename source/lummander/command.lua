...
function Command:usage(flag_usage, lummander_tag)
    ...
    cmd_prev = cmd_prev .. "  "
    print(cmd_prev..self.lummander.theme.command.definition.color.bold((lummander_tag and lummander_tag .." " or "") ..self:usage_cmd()).." -> " .. self.lummander.theme.command.description.color(self.description))
end
